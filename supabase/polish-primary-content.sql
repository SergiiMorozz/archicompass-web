...
update public.profiles set
  ...
  bio = case id
    ...
    when 'd0000000-0000-4000-8000-000000000003' then 'Piotr projektuje swobodne i trwałe domy w całym Trójmieście. Jego realizacje wyróżniają się czytelną komunikacją, oszczędnym detalem i paletą inspirowaną Bałtykiem, z dużą uwagą dla światła dziennego i łatwego utrzymania.'
