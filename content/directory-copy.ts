...
type DirectoryCopy = {
  ...
  results: {
    ...
    locationUnavailable: (location: string) => string;
    relaxedFallback: (location: string) => string;
    studiosTitle: string;
    studiosBody: string;
...
const pl: DirectoryCopy = {
  ...
  results: {
    ...
    locationUnavailable: (location) => `Nie udało się automatycznie potwierdzić odległości dla lokalizacji ${location}. Pokazujemy dostępne profile — przed kontaktem sprawdź lokalizację, portfolio oraz możliwość współpracy zdalnej.`,
    relaxedFallback: (location) => location
      ? `Nie znaleźliśmy profili spełniających jednocześnie wszystkie kryteria dla ${location}. Pokazujemy najbardziej trafne dostępne profile i pracownie pracujące także zdalnie. Przed kontaktem sprawdź portfolio oraz zakres współpracy.`
      : "Nie znaleźliśmy profili spełniających jednocześnie wszystkie wybrane kryteria. Pokazujemy najbardziej trafne dostępne profile i pracownie. Przed kontaktem sprawdź portfolio oraz zakres współpracy.",
    studiosTitle: "Pracownie projektowe", studiosBody: "Skontaktuj się z całym zespołem i zobacz projekty powiązanych projektantów.", briefRecommended: "Rekomendowani do Twojego briefu", matchingNotice: "Kolejność opiera się na informacjach z briefu i publicznych profilach, m.in. stylu, zakresie, usługach, lokalizacji, budżecie, terminie oraz portfolio. To wskazówka, nie certyfikacja ani gwarancja współpracy.", matchingLink: "Jak działa dopasowanie", recommended: "Polecani specjaliści", sortRecommended: "Polecane", sortNewest: "Najnowsze", sortExperience: "Doświadczenie", list: "Lista", grid: "Siatka", loadingError: "Nie udało się wczytać profili", emptyTitle: "Żaden projektant nie spełnia wybranych kryteriów", emptyBrief: "Nie znaleziono jeszcze dokładnego dopasowania. Poszerz lokalizację lub wybór stylów albo zapisz brief i wróć, gdy dołączą kolejni specjaliści.", emptySearch: "Usuń część filtrów lub wyszukaj inne miasto.", showAll: "Pokaż cały katalog",
  },
