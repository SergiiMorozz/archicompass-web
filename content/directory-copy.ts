...
const en: DirectoryCopy = {
  ...
  results: {
    nearbyFallback: (location) => `No profiles were found exactly in ${location}. Showing professionals from the nearest available locations, ordered by distance.`, locationUnavailable: (location) => `We could not automatically confirm distances for ${location}. Showing available profiles — check the location, portfolio and remote collaboration options before contacting them.`, relaxedFallback: (location) => location
      ...
      : "No profiles meet every selected criterion. Showing the most relevant available profiles and studios. Check the portfolio and collaboration scope before contacting them.", studiosTitle: "Design studios", studiosBody: "Contact the whole team and see projects from linked designers.", briefRecommended: "Recommended for your brief", recommended: "Recommended professionals", sortRecommended: "Recommended", sortNewest: "Newest", sortExperience: "Experience", list: "List", grid: "Grid", loadingError: "Unable to load profiles", emptyTitle: "No designers match the selected criteria", emptyBrief: "There is no exact match yet. Widen the location or style selection, or save the brief and return when more professionals join.", emptySearch: "Remove some filters or search for another city.", showAll: "Show the full directory",
  },
