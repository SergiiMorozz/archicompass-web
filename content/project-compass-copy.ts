...
type ProjectCompassCopy = {
  ...
  ui: {
    ...
    notSelected: string;
    stylesHint: string;
    showMoreStyles: (count: number) => string;
    showFewerStyles: string;
...
const projectCompassCopy: Record<SiteLocale, ProjectCompassCopy> = {
  pl: {
    ...
    ui: {
      ...
      showMoreStyles: (count) => `Pokaż więcej stylów (${count})`, showFewerStyles: "Pokaż mniej stylów",
      ...
      workspace: {
        ...
        progressTitle: "Twój AI Project Compass",
        ...
        journey: ["Inspiracje i analiza AI", "Preferencje i kierunek stylu", "Szczegóły projektu", "Zakres współpracy", "Budżet i termin"],
        inspirations: { title: "Inspiracje i analiza AI", body: "Dodaj zdjęcia wnętrz, uruchom analizę AI i otrzymaj pierwszą propozycję stylu, palety oraz materiałów.", previewEmpty: "Dodaj zdjęcia wnętrz, aby rozpocząć analizę AI.", previewReady: (count) => `Dodano ${count} zdjęć. Uruchom analizę AI, aby otrzymać kierunek.` },
        ...
        preferences: { title: "Preferencje i kierunek stylu", body: "AI wstępnie uzupełnia styl i sygnały wizualne. Możesz je swobodnie poprawić lub rozwinąć.", previewEmpty: "Doprecyzuj kierunek, który AI odczyta z inspiracji." },
        ...
        manualStyleBody: "Kierunek został wybrany ręcznie. Dodaj zdjęcia, aby otrzymać także analizę AI palety i materiałów.",
        ...
        matchingReadyTitle: "Twój AI Project Compass jest gotowy",
        matchingReadyBody: "Możesz przejrzeć wstępne dopasowania bez konta. Konto jest potrzebne tylko do zapisania briefu i powrotu do niego później.",
      ...
      steps: {
        projectType: "Co planujesz?", space: "Opowiedz o przestrzeni", spaceBody: "Wystarczą dane orientacyjne. Pomogą projektantom oszacować zakres pracy jeszcze przed pierwszą rozmową.", area: "Powierzchnia, m²", areaPlaceholder: "np. 72", roomsCount: "Liczba pomieszczeń", roomsCountPlaceholder: "np. 3", roomsIncluded: "Pomieszczenia objęte projektem", propertyStatus: "Jaki jest status nieruchomości?", goal: "Jaki jest główny cel projektu?", photos: "Dodaj zdjęcia referencyjne", photosBody: "Dodaj 4-10 zdjęć wnętrz, detali lub nastrojów, które Ci się podobają. Podgląd pozostaje w tej przeglądarce do chwili uruchomienia analizy lub zapisania briefu. Zapisane pliki trafiają do prywatnego briefu.", photoLimit: "Osiągnięto limit zdjęć", photoLimitReached: "Osiągnięto limit zdjęć", addPhotos: "Dodaj zdjęcia referencyjne", preparingPhotos: "Przygotowywanie zdjęć...", photoTypes: "JPEG, PNG lub WebP. Dodaj kilka zdjęć, aby łatwiej rozpoznać wspólne cechy.", removePhoto: "Usuń", noPhotos: "Nie dodano jeszcze zdjęć. Zacznij od obrazów, które najlepiej oddają oczekiwany nastrój, materiał, światło lub detal.", aiTitle: "Analiza stylu ze zdjęć", aiBody: "ArchiCompass przeanalizuje zdjęcia i zaproponuje nazwę stylu, materiały, kolory oraz wskazówki pomocne przy wyborze projektanta.", analyzing: "Analizowanie...", analyze: "Analizuj zdjęcia", aiPrivacyBefore: "Analiza wysyła maksymalnie", privacy: "Politykę prywatności", aiPrivacyAfter: "zdjęć do dostawcy usługi AI. Nie przesyłaj wizerunków osób, adresów ani informacji poufnych. Zobacz", aiTransparencyNotice: "AI pomaga analizować przesłane inspiracje i przygotować sugestie. Wynik ma charakter pomocniczy — ostateczne decyzje należą do Ciebie i wybranego projektanta.", aiTransparencyLink: "Jak działa AI", manyPhotos: (count) => `Analiza AI wykorzysta pierwsze ${count} zdjęć, aby wynik był szybki i precyzyjny. Wszystkie zdjęcia nadal można zapisać w briefie.`, suggestedStyle: "Sugerowany styl", confidencePrefix: "pewność:", closestDirection: "Najbliższy kierunek", colors: "Kolory", materials: "Materiały", styleClues: "Cechy stylu", tooLittleData: "Za mało danych", describeNeeds: "Jak opisać potrzeby projektantowi", watchOuts: "Na co uważać", analysisUnavailable: "Analiza AI jest niedostępna", visualCues: "Co łączy te zdjęcia?", style: "Które kierunki są Ci najbliższe?", scope: "Jaki zakres współpracy będzie potrzebny?", budget: "Całkowity budżet inwestycji (projektant + materiały + wykonanie)", timeline: "Kiedy chcesz rozpocząć?", visualization: "Czy potrzebujesz wizualizacji 3D?", supervision: "Jakiego nadzoru potrzebujesz?",
      },
      location: "Lokalizacja", locationPlaceholder: "Warszawa, Kraków, Gdańsk...", notes: "Dodatkowe informacje", notesPlaceholder: "Dzieci, wynajem, termin, wykonawca...", ready: "Gotowe?", readyBody: "Zapisz brief i przejdź od razu do dopasowań, przejrzyj je bez zapisywania albo zachowaj brief na później.", saveAccountHint: "Aby zapisać brief i wrócić do niego później, utwórz konto lub zaloguj się.", designerOnly: "Jako projektant możesz korzystać z analizy AI i podglądu dopasowań, ale zapisywanie oraz wysyłanie briefów klienta jest zablokowane.", saveAndFind: "Zapisz brief i przejdź do dopasowań", saving: "Zapisywanie briefu...", viewMatches: "Przejrzyj dopasowania bez zapisywania briefu", copyBrief: "Kopiuj brief", briefCopied: "Brief skopiowany",
      brief: {
        title: "Twój brief", goal: "Cel", area: "Powierzchnia", rooms: "Pomieszczenia", property: "Nieruchomość", style: "Styl", photos: "Zdjęcia", visualCues: "Cechy wizualne", support: "Wsparcie", budget: "Budżet", timeline: "Termin", visualization: "3D", supervision: "Nadzór", nextStep: "Rekomendowany następny krok", designerTip: "Wskazówka do wyboru projektanta", designerTipBody: (cue, scope) => `Szukaj portfolio z cechami takimi jak ${cue.toLowerCase()} i zapytaj, czy projektant oferuje zakres: ${scope.toLowerCase()}.`, designerNoticeTitle: "Jesteś zalogowany jako projektant", designerNoticeBody: "Analiza zdjęć AI, wskazówki stylistyczne, kopiowanie i podgląd dopasowań pozostają dostępne. Konto projektanta nie może zapisywać ani wysyłać briefów klienta.", saveForLater: "Zapisz brief na później", savedTitle: "Brief zapisany", savedBody: (count) => `Zapisano ${count} ${count === 1 ? "zdjęcie referencyjne" : count >= 2 && count <= 4 ? "zdjęcia referencyjne" : "zdjęć referencyjnych"}. Brief jest gotowy do wysłania projektantowi.`, openSavedBriefs: "Otwórz zapisane briefy", saveFailed: "Nie udało się zapisać briefu", mobileMatches: "Przejrzyj dopasowania bez zapisywania", mobileSaveAndFind: "Zapisz i przejdź do dopasowań", mobileSaving: "Zapisywanie...", mobileCopied: "Skopiowano", mobileCopy: "Kopiuj",
      },
      draft: {
  ...
  en: {
    ...
    ui: {
      ...
      showMoreStyles: (count) => `Show ${count} more styles`, showFewerStyles: "Show fewer styles",
      ...
      workspace: {
        ...
        progressTitle: "Your AI Project Compass",
        ...
        journey: ["Inspiration and AI analysis", "Preferences and style direction", "Project details", "Collaboration scope", "Budget and timeline"],
        inspirations: { title: "Inspiration and AI analysis", body: "Add interior photos, run AI analysis and receive an initial direction for the style, palette and materials.", previewEmpty: "Add interior photos to start the AI analysis.", previewReady: (count) => `${count} photos added. Run AI analysis to receive your initial direction.` },
        ...
        preferences: { title: "Preferences and style direction", body: "AI pre-fills the style and visual signals. You can freely refine or expand them.", previewEmpty: "Refine the direction AI reads from your inspirations." },
        ...
        manualStyleBody: "This direction was selected manually. Add photos to also receive AI analysis of the palette and materials.",
        ...
        matchingReadyTitle: "Your AI Project Compass is ready",
        matchingReadyBody: "You can preview initial matches without an account. An account is only needed to save the brief and return to it later.",
      ...
      steps: {
        projectType: "What are you planning?", space: "Tell us about the space", spaceBody: "Approximate details are enough. They help designers estimate the scope before the first conversation.", area: "Area, m²", areaPlaceholder: "e.g. 72", roomsCount: "Number of rooms", roomsCountPlaceholder: "e.g. 3", roomsIncluded: "Rooms included in the project", propertyStatus: "What is the property status?", goal: "What is the main outcome you need?", photos: "Add reference photos", photosBody: "Add 4-10 photos of interiors, details or moods you like. The preview stays in this browser until you run the analysis or save the brief. Saved files are added to your private brief.", photoLimit: "Photo limit reached", photoLimitReached: "Photo limit reached", addPhotos: "Add reference photos", preparingPhotos: "Preparing photos...", photoTypes: "JPEG, PNG or WebP. Add several photos to make shared visual patterns easier to identify.", removePhoto: "Remove", noPhotos: "No photos have been added yet. Start with the images that best capture the mood, material, lighting or detail you want.", aiTitle: "Photo style analysis", aiBody: "ArchiCompass will analyse the photos and suggest a style name, materials, colours and cues that help you choose a designer.", analyzing: "Analysing...", analyze: "Analyse photos", aiPrivacyBefore: "The analysis sends up to", privacy: "Privacy Policy", aiPrivacyAfter: "photos to the AI service provider. Do not upload images of people, addresses, or confidential information. Read the", aiTransparencyNotice: "AI helps analyse the inspiration you upload and prepare suggestions. The result is supportive only — final decisions remain with you and your chosen designer.", aiTransparencyLink: "How AI works", manyPhotos: (count) => `The AI analysis will use the first ${count} photos to keep the result fast and focused. All photos can still be saved with the brief.`, suggestedStyle: "Suggested style", confidencePrefix: "confidence:", closestDirection: "Closest direction", colors: "Colours", materials: "Materials", styleClues: "Style clues", tooLittleData: "Not enough information", describeNeeds: "How to describe your needs to a designer", watchOuts: "What to keep in mind", analysisUnavailable: "AI analysis is unavailable", visualCues: "What do these photos have in common?", style: "Which directions feel closest to you?", scope: "What level of collaboration will you need?", budget: "Total investment budget (designer + materials + works)", timeline: "When would you like to begin?", visualization: "Do you need 3D visualisations?", supervision: "What level of supervision do you need?",
      },
      location: "Location", locationPlaceholder: "Warsaw, Krakow, Gdansk...", notes: "Additional information", notesPlaceholder: "Children, rental, timing, contractor...", ready: "Ready?", readyBody: "Save the brief and go straight to matches, preview matches without saving, or keep the brief for later.", saveAccountHint: "Create an account or sign in to save the brief and return to it later.", designerOnly: "As a designer, you can use the AI analysis and preview the matches, but saving and sending a client brief is unavailable.", saveAndFind: "Save brief and go to matches", saving: "Saving brief...", viewMatches: "Preview matches without saving the brief", copyBrief: "Copy brief", briefCopied: "Brief copied",
      brief: {
        title: "Your brief", goal: "Goal", area: "Area", rooms: "Rooms", property: "Property", style: "Style", photos: "Photos", visualCues: "Visual cues", support: "Support", budget: "Budget", timeline: "Timeline", visualization: "3D", supervision: "Supervision", nextStep: "Recommended next step", designerTip: "Tip for choosing a designer", designerTipBody: (cue, scope) => `Look for portfolios with cues such as ${cue.toLowerCase()} and ask whether the designer offers ${scope.toLowerCase()}.`, designerNoticeTitle: "You are signed in as a designer", designerNoticeBody: "AI photo analysis, style guidance, copying and match previews remain available. A designer account cannot save or send client briefs.", saveForLater: "Save brief for later", savedTitle: "Brief saved", savedBody: (count) => `Saved ${count} reference ${count === 1 ? "photo" : "photos"}. The brief is ready to send to a designer.`, openSavedBriefs: "Open saved briefs", saveFailed: "Could not save the brief", mobileMatches: "Preview matches without saving", mobileSaveAndFind: "Save and go to matches", mobileSaving: "Saving...", mobileCopied: "Copied", mobileCopy: "Copy",
      },
      draft: {
