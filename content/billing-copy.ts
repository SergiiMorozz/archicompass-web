...
const copy: Record<SiteLocale, BillingCopy> = {
  pl: {
    pricing: {
      ...
      intro: "ArchiCompass pozostaje bezpłatny dla klientów. Projektanci i pracownie otrzymują pełny dostęp przez pierwsze 3 miesiące, a następnie wybierają plan, aby utrzymać aktywny profil, portfolio i zapytania.",
      ...
      plans: {
        designer: {
          ...
          features: ["Profil w Katalogu Projektantów", "Portfolio i projekty", "Briefy, wiadomości i statystyki", "Google Business rating i linki społecznościowe"],
        },
        studio: {
          title: "Pracownia",
          ...
          features: ["Wspólny profil pracowni i portfolio", "Zespół projektantów i wspólna skrzynka", "Zapytania kierowane do pracowni", "Statystyki i rozliczenia dla firmy"],
        },
      },
      vatNote: "Wszystkie ceny są cenami netto. VAT jest naliczany zgodnie z obowiązującą stawką. Dla firm można podać dane do faktury i NIP / VAT UE.",
  ...
  en: {
    pricing: {
      ...
      plans: {
        ...
        studio: { title: "Studio", description: "For teams operating under a shared studio profile.", monthly: "PLN 199 / month", yearly: "PLN 1,099 / year", yearlyNote: "A better rate with annual billing.", features: ["Shared studio profile and portfolio", "Designer team and shared inbox", "Enquiries addressed to the studio", "Analytics and company billing"] },
      },
